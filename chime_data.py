    ...
    for stage in ['tr','dt']:
       ...
       # mkdir_p(os.path.join(dest_dir, stage))
        for idx in range(len(flist)):
            ...
            X = stft(clean_audio, time_dim=1, size=256, shift=128).transpose((1, 0, 2))
            N = stft(noise_audio, time_dim=1, size=256, shift=128).transpose((1, 0, 2))
...
#prepare_training_data('/talc/multispeech/calcul/users/zwang/Data/CHiME3','/talc/multispeech/calcul/users/zwang/NN_PMWF/data')
